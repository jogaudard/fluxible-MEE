...
\hypersetup{
  pdftitle={Supporting Information for fluxible R package},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}


\title{Supporting Information for fluxible R package}
\author{}
\date{2025-09-10}
...
\begin{tcolorbox}[enhanced jigsaw, title={Handling lots of data?}, breakable, coltitle=black, rightrule=.15mm, toprule=.15mm, toptitle=1mm, left=2mm, arc=.35mm, colback=white, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, bottomrule=.15mm, leftrule=.75mm, opacityback=0, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Redefining the focus window}, breakable, coltitle=black, rightrule=.15mm, toprule=.15mm, toptitle=1mm, left=2mm, arc=.35mm, colback=white, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, bottomrule=.15mm, leftrule=.75mm, opacityback=0, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={The importance of reporting}, breakable, coltitle=black, rightrule=.15mm, toprule=.15mm, toptitle=1mm, left=2mm, arc=.35mm, colback=white, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, bottomrule=.15mm, leftrule=.75mm, opacityback=0, bottomtitle=1mm]
